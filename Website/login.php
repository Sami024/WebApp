...
<body>
    ...
    if (isset($_POST['login'])) {
        ...
        if ($result = $resultSet->fetch()) {
            // kijken of het wachtwoord overeenkomt
            if ($_POST['password'] == $result['password']) {
                ...
                // Als het wachtwoord niet overeenkomt, stel een foutmelding in
                $errorMessage = "Verkeerd wachtwoord";
            }
        } else {
            // Als het e-mailadres niet gevonden wordt in de database, stel een foutmelding in

...
<body>
    ...
    <form action="" method="POST" class="reis-pagina-container">
        ...
        <input style="color: var(--Black)" class="admin-button-edit" name="sterren" type="number" min="1" max="5"
            value="1">
        <br>
        <br>
        ...
        <input style="color: var(--Black)" class="admin-button-edit" name="recensie_posten" type="submit"
            value="recensie">
    </form>
</body>
